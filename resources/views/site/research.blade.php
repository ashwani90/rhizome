...
@section('content')
<div class="box-layout" style="margin-top: 200px;">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-12 col-lg-5 col-md-9 md-margin-40px-bottom xs-margin-30px-bottom wow animate__fadeIn" data-wow-delay="0.2s">
                            <h6 class="alt-font text-black line-height-44px mb-0 md-line-height-34px sm-line-height-30px sm-w-80 xs-w-100">We are passionate knowing that people work, play and inhabit the spaces and places.</h6>
                        </div>
                        <div class="col-12 col-lg-3 offset-lg-1 col-sm-6 last-paragraph-no-margin xs-margin-30px-bottom wow animate__fadeIn" data-wow-delay="0.3s">
                            <span class="alt-font font-weight-500 text-whitblacke text-uppercase letter-spacing-1px d-block margin-5px-bottom">Owner managed</span>
                        ...
                        <div class="col-12 col-lg-3 col-sm-6 last-paragraph-no-margin wow animate__fadeIn" data-wow-delay="0.4s">
                            <span class="alt-font font-weight-500 text-black text-uppercase letter-spacing-1px d-block margin-5px-bottom">Expect creativity</span>
                            <p class="w-85 lg-w-100 md-w-80 sm-w-90 xs-w-100">Lorem ipsum is simply dummy text of the printing and lorem ipsum has been.</p>
                        </div>
                    </div>
                </div>
