...
@section('title', 'Rhizomespace Project Architecture')
...
@section('content')
    ...
    <section class="overlap-height" style="padding: 100px; padding-bottom: 50px;">
        ...
        <!-- end banner section -->
        <!-- start section -->
        <section class="wow animate__fadeIn padding-six-lr xl-padding-three-lr lg-padding-two-lr xs-no-padding-lr" style="padding-top: 0px;">
        ...
        <section class="overlap-height"  style="padding-top: 30px;">
            <div class="container">
                <div class="row overlap-gap-section">
                @if ($project->title)
                    <div class="col-12 col-lg-6 col-sm-12 text-center text-md-start md-margin-20px-bottom">
