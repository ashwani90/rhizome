        ...
        @endif
                    <div class="container-fluid h-100px md-h-70px">
                        <div class="col-6 col-lg-2 me-auto ps-lg-0">
                            ...
                            <img loading="lazy" id="navbar-logo-white" src="assets/img/logo9.webp" data-at2x="assets/img/logo9.webp" class="default-logo" alt="" style="max-height: 60px;">
                            <img loading="lazy" id="navbar-logo-black" src="assets/img/logo10.webp" data-at2x="assets/img/logo10.webp" class="default-logo" alt="" style="max-height: 60px;display: none;">
                             <img loading="lazy" src="assets/img/logo10.webp" data-at2x="assets/img/logo10.webp" class="alt-logo" alt="" style="max-height: 60px;">
                            <img loading="lazy" id="navbar-logo-white-mob" src="assets/img/logo9.webp" data-at2x="assets/img/logo9.webp" class="mobile-logo" alt="" style="max-height: 60px;">
                            <img loading="lazy" id="navbar-logo-black-mob" src="assets/img/logo10.webp" data-at2x="assets/img/logo10.webp" class="mobile-logo" alt="" style="max-height: 60px; display: none;">
                            </a>
                        </div>
