<header class="home-vertical-portfolio">
                ...
                <div class="container-fluid h-130px md-h-70px">
                    <div class="col-6 col-lg-2 me-auto me-auto ps-lg-0">
                        <a class="navbar-brand" href="index.html">
                            <img src="images/symbol.png" data-at2x="images/symbol@2x.png" class="default-logo" alt="">
                            <img src="images/symbol.png" data-at2x="images/symbol@2x.png" class="alt-logo" alt="">
                            <img src="images/symbol-black.png" data-at2x="images/symbol-black@2x.png" class="mobile-logo" alt="">
                        </a>
                    </div>
            ...
            <div class="hamburger-menu hamburger-menu-half bg-black lg-w-60 md-w-60 sm-w-100">
                ...
                <div class="d-flex flex-column align-items-center justify-content-center h-100 padding-6-rem-all md-padding-2-rem-lr xs-no-padding-lr">
                    <a href="index.html" class="d-none d-lg-inline-block"><img src="images/logo-white-big.png" alt="" class="md-w-160px" /></a>
